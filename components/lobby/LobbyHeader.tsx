...
export default function LobbyHeader({ title, category, viewers, gifts }: LobbyHeaderProps) {
  return (
    <div className="bg-white shadow-sm p-3 md:p-4">
      <h1 className="text-xl md:text-2xl font-bold text-unicef">{title}</h1>
      <div className="flex flex-wrap items-center mt-2 gap-y-2">
        <span className="bg-unicef text-white text-xs md:text-sm px-2 md:px-3 py-0.5 rounded-md mr-3 md:mr-4">{category}</span>
